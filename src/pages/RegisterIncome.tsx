...
import { getIncomes, saveIncomes } from "@/lib/finance";
...
export default function RegisterIncome() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    incomes.push({ id: crypto.randomUUID(), monto: value, descripcion: descripcion.trim(), fecha: new Date().toISOString() });
    saveIncomes(incomes);
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center px-6 pt-10 max-w-lg mx-auto w-full">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-5">
          ...
          <Button type="submit" className="w-full gradient-hero text-primary-foreground font-semibold h-12 text-base">
            Registrar
          </Button>
